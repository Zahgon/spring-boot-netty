...
public final class OnConnectMethodInvoker extends AbstractMethodInvoker {
    ...
    public OnConnectMethodInvoker(final Object bean, final Method method, final List<NettyOnConnectParameterResolver> parameterResolvers, final boolean sendResult) {
